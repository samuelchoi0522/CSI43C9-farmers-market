...
create index vt_vendor_id_date_index if not exists on vendor_transactions (vendor_id, market_date);
create index vt_vendor_name_date_index if not exists on vendor_transactions (vendor_name, market_date);
