        ...
        <DialogPrimitive.Root open={isOpen} onOpenChange={onOpenChange}>
            <DialogPrimitive.Portal>
                ...
                <DialogPrimitive.Content 
                    className="fixed left-[50%] top-[50%] z-50 w-full max-w-2xl translate-x-[-50%] translate-y-[-50%] border border-slate-200 bg-white shadow-2xl duration-200 sm:rounded-2xl overflow-hidden flex flex-col max-h-[90vh]"
                >
                    ...
                    <div className="p-6 border-b border-slate-200 flex items-center justify-between bg-slate-50 shrink-0">
                        ...
                        <DialogPrimitive.Close asChild>
                            <button className="p-2 rounded-full hover:bg-slate-200 transition-colors text-slate-500">
                                <X size={20} />
                            </button>
                    ...
                    <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-8">
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className={cn(
                                            ...
                                            errors.vendorName ? "border-red-500" : "border-slate-200"
                                        )}
                                    />
                                    {errors.vendorName && <p className="text-xs text-red-500">{errors.vendorName}</p>}
                                </div>
                                <div className="space-y-2">
                                    <label htmlFor="pointPerson" className="text-sm font-medium text-slate-700">
                                        Point Person
                                    </label>
                                    <input
                                        id="pointPerson"
                                        ...
                                        onChange={handleInputChange}
                                        className="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-dashboard-primary outline-none transition-all text-slate-900"
                                    />
                                </div>
                                <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    <label htmlFor="miles" className="text-sm font-medium text-slate-700">
                                        Miles from Market
                                    </label>
                                    <input
                                        type="number"
                                ...
                                <div className="md:col-span-2 space-y-2">
                                    <label htmlFor="products" className="text-sm font-medium text-slate-700">
                                        Products
                                    </label>
                                    <textarea
                                        id="products"
                                        ...
                                        onChange={handleInputChange}
                                        rows={3}
                                        className="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-dashboard-primary outline-none transition-all resize-none text-slate-900"
                                    />
                                </div>
                        ...
                        <section className="space-y-4">
                                ...
                                {percentageFields.map(({ key, label }) => (
                                    <div key={key} className="space-y-1">
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className={cn(
                                                "w-full px-3 py-1.5 bg-slate-50 border rounded-lg focus:ring-2 focus:ring-dashboard-primary outline-none transition-all text-sm text-slate-900",
                                                errors[key] ? "border-red-500" : "border-slate-200"
                                            )}
                                        />
                                    </div>
                                ))}
                            ...
                            {errors.percentageSum && (
                                <div className="flex items-center gap-2 text-red-500 p-2 bg-red-50 rounded-lg">
                                    <AlertCircle size={16} />
            ...
            <AlertDialog open={showDeactivateConfirm} onOpenChange={setShowDeactivateConfirm}>
                <AlertDialogContent className="bg-white border-slate-200">
                    <AlertDialogHeader>
                        <AlertDialogTitle className="text-slate-900">Deactivate Vendor?</AlertDialogTitle>
            ...
            <AlertDialog open={showActivateConfirm} onOpenChange={setShowActivateConfirm}>
                <AlertDialogContent className="bg-white border-slate-200">
                    <AlertDialogHeader>
                        <AlertDialogTitle className="text-slate-900">Reactivate Vendor?</AlertDialogTitle>
                        <AlertDialogDescription className="text-slate-500">
